...
import top.cuggis.geotools.grv.MyTextPane
import top.cuggis.geotools.grv.MyPrintStream
...
class script{
    static void main(String[] args) {
        try {
            ...
            ide.visible = true
            JTextPane text = new MyTextPane() as JTextPane
            JScrollPane scroll = new JScrollPane(text as Component)
